...
let s:one_dark_nord_vim_version="0.15.0"
let g:airline#themes#onedarknord#palette = {}
...
let g:airline#themes#onedarknord#palette.normal = airline#themes#generate_color_map(s:NMain, s:NRight, s:NMiddle)
let g:airline#themes#onedarknord#palette.normal.airline_warning = s:NWarn
let g:airline#themes#onedarknord#palette.normal.airline_error = s:NError
...
let g:airline#themes#onedarknord#palette.insert = airline#themes#generate_color_map(s:IMain, s:IRight, s:IMiddle)
let g:airline#themes#onedarknord#palette.insert.airline_warning = s:IWarn
let g:airline#themes#onedarknord#palette.insert.airline_error = s:IError
...
let g:airline#themes#onedarknord#palette.replace = airline#themes#generate_color_map(s:RMain, s:RRight, s:RMiddle)
let g:airline#themes#onedarknord#palette.replace.airline_warning = s:RWarn
let g:airline#themes#onedarknord#palette.replace.airline_error = s:RError
...
let g:airline#themes#onedarknord#palette.visual = airline#themes#generate_color_map(s:VMain, s:VRight, s:VMiddle)
let g:airline#themes#onedarknord#palette.visual.airline_warning = s:VWarn
let g:airline#themes#onedarknord#palette.visual.airline_error = s:VError
...
let g:airline#themes#onedarknord#palette.inactive = airline#themes#generate_color_map(s:IAMain, s:IARight, s:IAMiddle)
let g:airline#themes#onedarknord#palette.inactive.airline_warning = s:IAWarn
let g:airline#themes#onedarknord#palette.inactive.airline_error = s:IAError

let g:airline#themes#onedarknord#palette.normal.airline_term = s:NMiddle
let g:airline#themes#onedarknord#palette.insert.airline_term = s:IMiddle
let g:airline#themes#onedarknord#palette.replace.airline_term = s:RMiddle
let g:airline#themes#onedarknord#palette.visual.airline_term = s:VMiddle
let g:airline#themes#onedarknord#palette.inactive.airline_term = s:IAMiddle
