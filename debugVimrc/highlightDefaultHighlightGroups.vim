...
match hdhgNormal          /Normal/
match hdhgBoolean         /Boolean/
match hdhgCharacter       /Character/
match hdhgComment         /Comment/
match hdhgConditional     /Conditional/
match hdhgConstant        /Constant/
match hdhgCursor          /Cursor/
match hdhgCursorLine      /CursorLine/
match hdhgCursorColumn    /CursorColumn/
match hdhgDebug           /Debug/
match hdhgDefine          /Define/
match hdhgDelimiter       /Delimiter/
match hdhgDiffAdd         /DiffAdd/
match hdhgDiffChange      /DiffChange/
match hdhgDiffDelete      /DiffDelete/
match hdhgDiffText        /DiffText/
match hdhgDirectory       /Directory/
match hdhgErrorMsg        /ErrorMsg/
match hdhgError           /Error/
match hdhgException       /Exception/
match hdhgFloat           /Float/
match hdhgFoldColumn      /FoldColumn/
match hdhgFolded          /Folded/
match hdhgFunction        /Function/
match hdhgIdentifier      /Identifier/
match hdhgIncSearch       /IncSearch/
match hdhgKeyword         /Keyword/
match hdhgLabel           /Label/
match hdhgLineNr          /LineNr/
match hdhgMacro           /Macro/
match hdhgModeMsg         /ModeMsg/
match hdhgMoreMsg         /MoreMsg/
match hdhgNonText         /NonText/
match hdhgNumber          /Number/
match hdhgOperator        /Operator/
match hdhgPreCondit       /PreCondit/
match hdhgPreProc         /PreProc/
match hdhgQuestion        /Question/
match hdhgRepeat          /Repeat/
match hdhgSearch          /Search/
match hdhgSpecialChar     /SpecialChar/
match hdhgSpecialComment  /SpecialComment/
match hdhgSpecial         /Special/
match hdhgSpecialKey      /SpecialKey/
match hdhgStatement       /Statement/
match hdhgStatusLine      /StatusLine/
match hdhgStatusLineNC    /StatusLineNC/
match hdhgStorageClass    /StorageClass/
match hdhgString          /String/
match hdhgStructure       /Structure/
match hdhgTag             /Tag/
match hdhgTitle           /Title/
match hdhgTodo            /Todo/
match hdhgTypedef         /Typedef/
match hdhgType            /Type/
match hdhgUnderlined      /Underlined/
match hdhgVertSplit       /VertSplit/
match hdhgVisualNOS       /VisualNOS/
match hdhgWarningMsg      /WarningMsg/
match hdhgWildMenu        /WildMenu/
