...
map("i", [[<C-w>k]],     [[<Esc><C-w>k]], "Window above")
map("i", [[<C-w>j]],     [[<Esc><C-w>j]], "Window below")
map("i", [[<C-w>h]],     [[<Esc><C-w>h]], "Window left")
map("i", [[<C-w>l]],     [[<Esc><C-w>l]], "Window right")
...
map("i", [[<C-w>]], [[<C-Right>]], "Move cursor to one word forward")
-- }}} Navigation
