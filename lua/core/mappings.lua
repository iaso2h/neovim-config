...
map("n", [[<C-i>]], function()
    require("searchHop").centerHop(function()
        require("jumplist")(true, "local")
    end, true, true)
end, {"silent"}, "Newer jump")
map("n", [[g<C-o>]], function()
    require("searchHop").centerHop(function()
        require("jumplist")(false, "buffer")
    end, true, true)
end, {"silent"}, "Older jump")
map("n", [[g<C-i>]], function()
    require("searchHop").centerHop(function()
        require("jumplist")(true, "buffer")
    end, true, true)
end, {"silent"}, "Newer jump")
...
map("i", [[<C-w>k]], [[<C-o><C-w>k<CMD>stopinsert<CR>]], {"noremap"}, "Window above")
map("i", [[<C-w>j]], [[<C-o><C-w>j<CMD>stopinsert<CR>]], {"noremap"}, "Window below")
