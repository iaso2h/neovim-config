...
-- Trailing character {{{
map("n", [[g.]], [[<CMD>lua require("trailingChar").main(vim.fn.mode(), ".")<CR>]],    {"silent"}, "Add trailing .")
map("x", [[g.]], [[:lua require("trailingChar").main(vim.fn.visualmode(), ".")<CR>]],  {"silent"}, "Add trailing .")
map("n", [[g,]], [[<CMD>lua require("trailingChar").main(vim.fn.mode(), ",")<CR>]],    {"silent"}, "Add trailing ,")
map("x", [[g,]], [[:lua require("trailingChar").main(vim.fn.visualmode(), ",")<CR>]],  {"silent"}, "Add trailing ,")
map("n", [[g;]], [[<CMD>lua require("trailingChar").main(vim.fn.mode(), ";")<CR>]],    {"silent"}, "Add trailing ;")
map("x", [[g;]], [[:lua require("trailingChar").main(vim.fn.visualmode(), ";")<CR>]],  {"silent"}, "Add trailing ;")
