return function()
    ...
    mason_null_ls.setup {
        ...
        handlers               = table.insert(handlerArgs, 0, function() end) -- insert a dummy handler to disable automatic setup
    }
    -- NOTE: registed sources won't list out individually in the LspInfo
    -- command output. They will be all listed under the "null-ls" source.
