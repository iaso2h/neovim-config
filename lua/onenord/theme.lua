...
theme.plugins = { -- {{{
    ...
    NvimTreeGitDeletedIcon = {link = "NvimTreeFileDeleted"},
    NvimTreeGitDirtyIcon   = {link = "NvimTreeFileDirty"},
    NvimTreeGitIgnoredIcon = {link = "NvimTreeFileIgnored"},
    NvimTreeGitMergeIcon   = {link = "NvimTreeFileMerge"},
    NvimTreeGitNewIcon     = {link = "NvimTreeFileNew"},
    NvimTreeGitRenamedIcon = {link = "NvimTreeFileRenamed"},
    NvimTreeGitStagedIcon  = {link = "NvimTreeFileStaged"},
    -- File Text
    ...
    -- Misc
    CmpItemKindFittenCode = {fg = p.n10},
