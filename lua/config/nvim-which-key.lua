return function()
    ...
    presets.operators["gU"] = nil
    presets.operators["lh"] = nil
    presets.operators["ya"] = nil
    presets.operators["yi"] = nil
    ...
    -- Document keymappings
    _G.whichKeyDoc = function(docs)
        require("which-key").register(docs)
    end
    whichKeyDoc(require("util").whichKeyDocs)
    WhichKeyDocRegistered = true
