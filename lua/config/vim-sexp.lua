return function()
    ...
    vim.g["sexp_mappings"] = {
        ...
        sexp_indent                    = '==',
        sexp_indent_top                = '=-',
        sexp_round_head_wrap_list      = 'gf(',
        sexp_round_tail_wrap_list      = 'gf)',
        sexp_square_head_wrap_list     = 'gf[',
        sexp_square_tail_wrap_list     = 'gf]',
        sexp_curly_head_wrap_list      = 'gf{',
        sexp_curly_tail_wrap_list      = 'gf}',
